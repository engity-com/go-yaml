...
var unmarshalTests = []struct {
	...
	{
		"a: {b: https://github.com/engity-com/go-yaml}",
		map[string]interface{}{"a": map[string]interface{}{
			"b": "https://github.com/engity-com/go-yaml",
		}},
	},
	{
		"a: [https://github.com/engity-com/go-yaml]",
		map[string]interface{}{"a": []interface{}{"https://github.com/engity-com/go-yaml"}},
	},
